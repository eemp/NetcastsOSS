...
part 'podcasts_with_relations.jser.dart';

class PodcastsWithRelations {
...

{
  ...
  @override
  String toString() {
    return 'PodcastsWithRelations[id=$id, artist=$artist, artwork100=$artwork100, artwork30=$artwork30, artwork600=$artwork600, artwork60=$artwork60, artworkOrig=$artworkOrig, description=$description, episodes=$episodes, feed=$feed, genres=$genres, lastModifiedTimestamp=$lastModifiedTimestamp, lastUpdated=$lastUpdated, name=$name, popularity=$popularity, primaryGenre=$primaryGenre, releaseDate=$releaseDate, type=$type, ]';
  }
}

@GenSerializer(nullableFields: true)
class PodcastsWithRelationsSerializer extends Serializer<PodcastsWithRelations> with _$PodcastsWithRelationsSerializer {
