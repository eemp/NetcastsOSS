...
part of 'podcasts_filter.dart';

// **************************************************************************
// JaguarSerializerGenerator
// **************************************************************************

abstract class _$PodcastsFilterSerializer
    implements Serializer<PodcastsFilter> {
  ...
  @override
  Map<String, dynamic> toMap(PodcastsFilter model) {
  ...
  @override
  PodcastsFilter fromMap(Map map) {
    if (map == null) return null;
    final obj = PodcastsFilter(
