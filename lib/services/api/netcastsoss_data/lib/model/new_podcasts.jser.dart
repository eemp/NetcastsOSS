...
part of 'new_podcasts.dart';

// **************************************************************************
// JaguarSerializerGenerator
// **************************************************************************

abstract class _$NewPodcastsSerializer implements Serializer<NewPodcasts> {
  @override
  Map<String, dynamic> toMap(NewPodcasts model) {
  ...
  @override
  NewPodcasts fromMap(Map map) {
    if (map == null) return null;
    final obj = NewPodcasts(
