...
part of 'podcasts_with_relations.dart';

// **************************************************************************
// JaguarSerializerGenerator
// **************************************************************************

abstract class _$PodcastsWithRelationsSerializer
    implements Serializer<PodcastsWithRelations> {
  @override
  Map<String, dynamic> toMap(PodcastsWithRelations model) {
  ...
  @override
  PodcastsWithRelations fromMap(Map map) {
    if (map == null) return null;
    final obj = PodcastsWithRelations(
