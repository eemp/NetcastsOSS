...
part 'podcasts_partial.jser.dart';

class PodcastsPartial {
...

{
  ...
  @override
  String toString() {
    return 'PodcastsPartial[id=$id, artist=$artist, artwork100=$artwork100, artwork30=$artwork30, artwork600=$artwork600, artwork60=$artwork60, artworkOrig=$artworkOrig, description=$description, episodes=$episodes, feed=$feed, genres=$genres, lastModifiedTimestamp=$lastModifiedTimestamp, lastUpdated=$lastUpdated, name=$name, popularity=$popularity, primaryGenre=$primaryGenre, releaseDate=$releaseDate, type=$type, ]';
  }
}

@GenSerializer(nullableFields: true)
class PodcastsPartialSerializer extends Serializer<PodcastsPartial> with _$PodcastsPartialSerializer {
